...
export default function JobDetailsContent({ job }: JobDetailsContentProps) {
  return (
    <div className="space-y-6 sm:space-y-8">
      {job.responsibilities && hasContent(job.responsibilities) && (
      ...
      {job.requirements && hasContent(job.requirements) && (
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
      ...
      {job.benefits && hasContent(job.benefits) && (
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
      ...
      {job.applicationRequirements && hasContent(job.applicationRequirements) && (
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
      ...
      {job.additionalNotes && hasContent(job.additionalNotes) && (
