...
const JobCard = ({ level, date, title, description }: Job) => {
  return (
    <div className="w-full sm:w-auto shadow-[0_6px_24px_rgba(0,0,0,0.05),0_0_0_1px_rgba(0,0,0,0.08)] rounded-lg bg-[var(--color-white)] flex flex-col items-start justify-start p-4 gap-5 border border-transparent hover:border-[var(--color-royalblue)] hover:bg-[var(--color-royalblue-200)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.1)] transition-all duration-300">
      ...
      <div className="rounded-xl flex flex-row items-center justify-center gap-2 text-[var(--color-royalblue)] hover:underline transition-all duration-300 cursor-pointer">
